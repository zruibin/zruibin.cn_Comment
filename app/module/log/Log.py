...
class Loger(object):  
    ...
    @classmethod
    def debug(cls, TAG, string, filename=__file__):
        string = "[%s][%s][%s] %s" % (TAG, filename, inspect.stack()[1][3], string)
        logging.debug(string)
        pass

    @classmethod
    def info(cls, TAG, string, filename=__file__):
        string = "[%s][%s][%s] %s" % (TAG, filename, inspect.stack()[1][3], string)
        logging.info(string)
        pass

    @classmethod
    def warning(cls, TAG, string, filename=__file__):
        string = "[%s][%s][%s] %s" % (TAG, filename, inspect.stack()[1][3], string)
        logging.warning(string)
        pass

    @staticmethod
    def error(TAG, string, filename=__file__):
